...
import {
  Lightbulb, Briefcase, Cloud,
} from "lucide-react"
import clsx from "clsx"

const tabs = [
  { label: "Ideas", href: "/ideas", icon: Lightbulb, key: "ideas" },
  { label: "Portfolio", href: "/portfolio", icon: Briefcase, key: "portfolio" },
  { label: "SaaS Bank", href: "/saas-bank", icon: Cloud, key: "saas" },
]

function VenturesContent() {
  useEffect(() => { document.title = "Ventures — LUMARY Studio" }, [])
  ...
  return (
    <div className="space-y-gutter animate-fadeIn">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-headline-lg font-bold text-on-surface">Ventures</h2>
      </div>
          ...
          return (
            ...
            >
              ...
              <p className="text-sm text-on-surface-variant/70">
                Explore your {tab.label.toLowerCase()}
              </p>
            </Link>
          )
        })}
